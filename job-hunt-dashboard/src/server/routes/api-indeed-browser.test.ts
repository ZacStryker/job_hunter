...
// Inject userId via middleware simulation
...
describe('POST / — create Indeed browser session', () => {
...
describe('DELETE /:id — cancel Indeed browser session', () => {
...
// NOTE: The WebSocket upgrade path (/api/onboarding/indeed/browser/:sessionId/ws)
