...
export interface IndeedBrowserSession {
...
export function useIndeedBrowserSession(): IndeedBrowserSession {
  ...
  const startSession = useCallback(async () => {
    ...
    try {
      const res = await apiFetch('/api/onboarding/indeed/browser', { method: 'POST' })
      if (!res.ok) {
      ...
      const wsUrl = `${proto}//${window.location.host}/api/onboarding/indeed/browser/${sessionId}/ws`
